		...
		<div className='md:flex-[2_2_0] w-18 max-w-52'>
			<div className='sticky top-0 left-0 h-screen flex flex-col border-r border-gray-700 w-20 md:w-full'>
				<Link to='/' className='flex justify-center md:justify-start'>
					...
					<FaSmileWink className='px-2 w-12 h-12 rounded-full fill-black '/>
					...
					>
						<div className='avatar hidden md:inline-flex'>
							<div className='w-8 rounded-full'>
								<img src={data?.profileImg || 'posts/avatar-placeholder.png'} alt = 'profileimage'/>
							</div>
						</div>
						<div className='flex justify-between flex-1'>
							<div className='hidden md:block'>
								<p className='text-sate-500 font-bold text-sm w-20 truncate'>{data.fullName}</p>
